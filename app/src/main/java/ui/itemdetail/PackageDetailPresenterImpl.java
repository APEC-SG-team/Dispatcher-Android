...
public class PackageDetailPresenterImpl implements PackageDetailPresenter, PackageDetailInteractor.OnReceivePackageDetailListener {

    private View mInboxPresenterView;
    private PackageDetailInteractor mInboxListInteractor;

    public PackageDetailPresenterImpl(View view, PackageDetailInteractor inboxListInteractor) {
